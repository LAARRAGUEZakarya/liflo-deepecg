...
def run_pipeline(npy_path, work_dir):
    ...
    pipeline = AnalysisPipeline(
        preprocessing_df=create_preprocessing_dataframe(str(manifest)),
        analysis_df=create_analysis_dataframe(str(manifest)),
    ...
    for f in out_dir.rglob("*.csv"):
        try:
            ...
            pass
    return {"status": "ok", "model": "deepecg", "findings": findings}
